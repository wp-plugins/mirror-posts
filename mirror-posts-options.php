...
### Variables
//$base_name = plugin_basename('wp-posturl/posturl-options.php');
//$base_page = 'admin.php?page='.$base_name;
//$mode = trim((!empty($_GET['mode'])) ? $_GET['mode'] : '');
$mode='';
...
if(!empty($_POST['Submit'])) {
    ...
    $posturl_options['add_credit'] = $_POST['add_credit'];
    $posturl_options['add_to_home'] = $_POST['add_to_home'];
    $posturl_options['add_to_category'] = $_POST['add_to_category'];
    $posturl_options['add_to_tag'] = $_POST['add_to_tag'];
    $posturl_options['add_to_archive'] = $_POST['add_to_archive'];
    $posturl_options['add_to_single'] = $_POST['add_to_single'];
    $posturl_options['add_to_feed'] = $_POST['add_to_feed'];
    $posturl_options['add_to_page'] = $_POST['add_to_page'];
    //$posturl_options['iner_url_str'] = $_POST['iner_url_str'];

    /*
    if(get_magic_quotes_gpc()) {
    } else
    {
        $posturl_options['post_url_text'] = addslashes($_POST['posturl_str']);
    }
     */
    $update_posturl_queries = array();
    $update_posturl_text = array();
    $update_posturl_queries[] = update_option('posturl_options', $posturl_options);
...
<script type="text/javascript">
    function views_default(template) {
        ...
        //document.getElementById("iner_url_str").value = '';
    }
</script>
<div class="wrap">
        <?php screen_icon(); ?>
        ...
        <table class="form-table">
            ...
            <?php /*
                <tr>
                    <td valign="top" width="30%"><strong><?php _e('User Specific Inner Post Text:', 'wp-posturl'); ?></strong><br />
                        <?php _e('If not empty, string "<code>%wpurl%</code>" within your post content will be replaced by this text.', 'wp-posturl'); ?><br /><br />
                        <?php _e('Also allow these variables: <code>%site_url%</code>, <code>%site_name%</code>, <code>%post_url%</code> and <code>%post_title%</code>.', 'wp-posturl'); ?>
                        </td>
                        <td>
                            <textarea name="iner_url_str" id="iner_url_str" cols="64" rows="6"><?php echo htmlspecialchars(stripslashes($posturl_options['iner_url_str']), ENT_QUOTES); ?></textarea><br />
                            <?php _e('<strong>Note:</strong> Use this feature with care. If you disable this feature or disable wp-postURL plugin later, your post may contain un-replaced string "<code>%wpurl%</code>".', 'wp-posturl'); ?>
                        </td>
                </tr>
                */ ?>
                <tr>
